...
export namespace Observers
{
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ServiceContract = Interfaces.Observers.Service;
    ...
    export class Observer
    {
        ...
        {
            const events = Services.Resolve('events') as
     ...
     *               `Services.Types.ObserverService` exactly: `Create` + `DrainAll`.
     *
     *               Without it `Services.Observer` stayed `undefined` forever, and
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export const Service = new Services.Service<ServiceContract>
    (
        'observer',
        {
            Create
