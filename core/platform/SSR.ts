...
export namespace SSR
{
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type IslandMode       = Types.SSR.IslandMode;
    /** @name        RenderOptions
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type RenderOptions    = Interfaces.SSR.RenderOptions;
    /** @name        HydrateOptions
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type HydrateOptions   = Interfaces.SSR.HydrateOptions;
    /** @name        NodeContract
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type NodeContract     = Interfaces.SSR.Node;
    /** @name        WorkerBridge
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type WorkerBridge     = Interfaces.SSR.WorkerBridge;
    /** @name        Application
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Application      = Interfaces.SSR.Application;
    /** @name        RenderResult
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type RenderResult     = Interfaces.SSR.RenderResult;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ServiceContract  = Interfaces.SSR.Service;
    ...
    export class Renderer
    {
            ...
            this.#options =
                {
                    ...
                    IdentifierPrefix: options?.IdentifierPrefix ?? 'arianna'
                };
        }
        ...
        {
            if(this.#options.Signal.aborted) throw this.#options.Signal.reason ?? new DOMException('SSR render aborted.', 'AbortError');
        ...
        RenderToReadableStream(node: NodeContract | Island): ReadableStream<Uint8Array>
        {
            const iterator = this.Stream(node)[Symbol.asyncIterator]();
            ...
            ({
                async pull(controller)
                {
                    if(signal.aborted)
                    {
                        ...
                        controller.error(signal.reason ?? new DOMException('SSR render aborted.', 'AbortError'));
                        return;
                    }
                    try
                    {
