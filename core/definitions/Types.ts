...
export namespace Types
{
    ...
    export namespace Core
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Packages = string | readonly string[] |
        {
            base?: string;
            core?: boolean | string;
     ...
     *  @public
     *  @type        {namespace}
     *  @description Groups the Services contracts and runtime surface. Service shapes live in Interfaces.Services.
     *  @author      Riccardo Angeli
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    ...
    export namespace DOM
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Native = Core.Primitive | 'class' | 'idl' | 'idl-patched' | Constructor;
        /** @name        Declaration
         *  @public
         *  @type        {type alias}
    ...
    export namespace Css
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type StylesheetArguments = import('../dom/Css.ts').Css.Stylesheet | import('../dom/Css.ts').Css.Rule | Interfaces.Css.StylesheetLike | CSSStyleSheet | CSSRuleList | HTMLLinkElement | CSSRule[] | Interfaces.Css.RuleLike[] | Interfaces.Css.RuleLike | Interfaces.Css.StylesheetObject | Interfaces.Css.StylesheetObjectInterface | string;
        /** @name        StyleValue
         *  @public
         *  @type        {type alias}
    ...
    export namespace Reactivity
    {
        ...
        /** Canonical semantic collection operation vocabulary. */
        export type CollectionOperation =
            'set' | 'add' | 'delete' | 'clear' | 'update' |
            'push' | 'pop' | 'shift' | 'unshift' | 'splice' |
            'sort' | 'reverse' | 'fill' | 'copyWithin' | 'truncate';

        /** Array-only imperative subset consumed by the compiled hot path. */
        export type ArrayOperation = CollectionOperation;
        /** @name        Schedule
         *  @public
         *  @type        {type alias}
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type WatchHandler<T> = (value: T, previous: T | undefined, OnCleanup: (cleanup: Cleanup) => void) => void;
        /** @name        ResourceState
         *  @public
         *  @type        {type alias}
    ...
    export namespace State
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type HistoryKind = 'create' | 'set' | 'update' | 'restore';
    }
    /** @name        Template
     *  @public
     *  @type        {namespace}
    ...
    export namespace Directives
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Update = Reactivity.Cleanup;
        /** @name        Kind
         *  @public
         *  @type        {type alias}
    ...
    export namespace Reals
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Child = string | Element | Node | (new (...args: unknown[]) => Element) | Default | Interfaces.Reals.Renderable | Interfaces.Reals.Definition | null;
        /** @name        Target
         *  @public
         *  @type        {type alias}
         *  @description Canonical type alias for Target.
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Target = string | Element | (new (...args: unknown[]) => Element) | Interfaces.Reals.Renderable | Interfaces.Reals.Definition | Default;
    }
    /** @name        Virtuals
     *  @public
     *  @type        {namespace}
    ...
    export namespace Virtuals
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Default = import('../components/Virtual.ts').Virtuals.Virtual;
        /** @name        Definition
         *  @public
         *  @type        {type alias}
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Child = import('../components/Virtual.ts').Virtuals.Virtual | string | number | boolean | null | undefined;
        /** @name        Target
         *  @public
         *  @type        {type alias}
         *  @description Canonical type alias for Target.
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Target = Definition | string | Node | Element | HTMLTemplateElement | import('../dom/Template.ts').Templates.Template | import('../dom/Real.ts').default | import('../components/Virtual.ts').Virtuals.Virtual;
    }
    /** @name        Context
     *  @public
     *  @type        {namespace}
    ...
    export namespace Context
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Scope = 'application' | 'request' | 'route' | 'component' | 'worker';
        /** @name        SourceKind
         *  @public
         *  @type        {type alias}
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type SourceKind = 'value' | 'state';
    }
    /** @name        Workers
     *  @public
     *  @type        {namespace}
    ...
    export namespace Workers
    {
        ...
        export type WorkerState = 'Created' | 'Starting' | 'Running' | 'Stopping' | 'Stopped' | 'Failed' | 'Disposed';
        /** Lifecycle of one AriannA WorkerPool. */
        export type PoolState = 'Created' | 'Starting' | 'Ready' | 'Draining' | 'Stopped' | 'Disposed';
        /** Lifecycle of a nominal Worker task. */
        export type TaskState = 'Queued' | 'Running' | 'Completed' | 'Failed' | 'Cancelled' | 'TimedOut';
        /** Message discriminator used by the AriannA Worker protocol. */
        export type ProtocolType = 'Task' | 'Message' | 'Result' | 'Error' | 'Signal' | 'Event' | 'Ready';
        /** @name        TaskFunction
         *  @public
         *  @type        {type alias}
    ...
    export namespace Router
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Status = 'idle' | 'loading' | 'ready' | 'blocked' | 'not-found' | 'cancelled' | 'error';
        /** @name        Mode
         *  @public
         *  @type        {type alias}
         *  @description Canonical type alias for Mode.
    ...
    export namespace Jsx
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Mode = DOM.RenderMode;
        /** @name        Key
         *  @public
         *  @type        {type alias}
         *  @description Canonical type alias for Key.
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Primitive = Css.StyleValue;
        /** @name        ElementType
         *  @public
         *  @type        {type alias}
        ...
        import('../components/Virtual.ts').Virtuals.Virtual | globalThis.Node | Interfaces.Jsx.Fragment | Primitive;
        /** @name        Children
         *  @public
         *  @type        {type alias}
    ...
    export namespace Plugins
    {
        ...
        options: Options) => void | Cleanup | Promise<void | Cleanup>;
    }
    /** @name        Properties
     *  @public
     *  @type        {namespace}
    ...
    export namespace Properties
    {
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Type = Core.Validation;
        /** @name        Ways
         *  @public
         *  @type        {type alias}
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Bindings = Record<string, Interfaces.Properties.Binding>;
        /** @name        Functions
         *  @public
         *  @type        {type alias}
         ...
         *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
         *  @license     MIT / Commercial (dual license) */
        export type Functions = Record<string, Interfaces.Properties.Hook>;
        /** @name        Hosts
         *  @public
         *  @type        {type alias}
