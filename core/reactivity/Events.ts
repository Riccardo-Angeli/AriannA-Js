...
export namespace Events
{
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type NativeEvent           = Types.Events.NativeEvent;
    /** @name        Target
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Phase                 = Types.Events.Phase;
    /** @name        EventType
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type EventType             = Interfaces.Events.EventType;
    /** @name        Broker
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Broker                = Interfaces.Events.Broker;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type EventDescriptor       = Interfaces.Events.EventDescriptor;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type EventTargetDescriptor = Interfaces.Events.EventTargetDescriptor;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ListenerDescriptor    = Interfaces.Events.ListenerDescriptor;
    /** @name        ListenerJson
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ListenerJson          = Interfaces.Events.Json;
    /** @name        ListenerXML
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ListenerXML           = Interfaces.Events.XML;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ServiceContract       = Interfaces.Events.Service;
    ...
    class Registry
    {
        static readonly DOM: Record<string, EventType> = {
    ...
    export class Event
    {
        ...
        /** Register DOM event metadata supplied by an optional platform pack. */
        static RegisterDOM(types: Readonly<Record<string, EventType>>): void
        {
            Object.assign(Registry.DOM, types);
        }
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    const Service = new Services.Service<ServiceContract & { Has(type: string): boolean }>
    (
        'events',
        {
            Fire
