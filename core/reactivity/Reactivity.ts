...
import { Reactive as ReactiveKernel } from './Reactive.ts';
...
export namespace Reactivity
{
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Key                            = Types.Reactivity.Key;
    /** @name        Path
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Path                           = Types.Reactivity.Path;
    /** @name        ChangeKind
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ChangeKind                     = Types.Reactivity.ChangeKind;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Schedule                       = Types.Reactivity.Schedule;
    /** @name        Equality
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Equality<T>                    = Types.Reactivity.Equality<T>;
    /** @name        Cleanup
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Cleanup                        = Types.Reactivity.Cleanup;
    /** @name        Stop
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Stop                           = Types.Reactivity.Stop;
    /** @name        WatchHandler
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type WatchHandler<T>                = Types.Reactivity.WatchHandler<T>;
    /** @name        ResourceState
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ResourceState                  = Types.Reactivity.ResourceState;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ResourceFetcher<T, S = unknown> = Types.Reactivity.ResourceFetcher<T, S>;
    /** @name        ChangeEvent
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ChangeEvent                    = Interfaces.Reactivity.ChangeEvent;
    /** @name        SignalOptions
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type SignalOptions<T>               = Interfaces.Reactivity.SignalOptions<T>;
    /** @name        EffectOptions
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type EffectOptions                  = Interfaces.Reactivity.EffectOptions;
    /** @name        WatchOptions
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type WatchOptions<T>                = Interfaces.Reactivity.WatchOptions<T>;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ReactiveOptions                = Interfaces.Reactivity.ReactiveOptions;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ResourceOptions<T>             = Interfaces.Reactivity.ResourceOptions<T>;
    /** @name        SignalContract
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type SignalContract<T>              = Interfaces.Reactivity.Signal<T>;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ReadonlySignalContract<T>      = Interfaces.Reactivity.ReadonlySignal<T>;
    /** @name        MemoContract
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type MemoContract<T>                = Interfaces.Reactivity.Memo<T>;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ResourceContract<T, S = unknown> = Interfaces.Reactivity.Resource<T, S>;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type SelectorContract<T, K = T>     = Interfaces.Reactivity.Selector<T, K>;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ReactionContract               = Interfaces.Reactivity.Reaction;
    /** @name        Snapshot
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Snapshot                       = Interfaces.Reactivity.Snapshot;
    /** @name        Subscriber
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Subscriber                     = Interfaces.Reactivity.Computation;
    /** @name        Dependency
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Dependency                     = Types.Reactivity.Dependency;
    /** @name        Owner
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Owner                          = Interfaces.Reactivity.Owner;
    /** @name        Computation
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Computation                    = Interfaces.Reactivity.Computation;
    /** @name        ProxyMeta
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ProxyMeta                      = Interfaces.Reactivity.ProxyMeta;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type TransactionEntry               = Interfaces.Reactivity.TransactionEntry;
    ...
    class Source implements Interfaces.Reactivity.SignalSource
    {
    ...
    const CollectionSnapshotKey = Symbol('AriannA.Reactivity.TransactionSnapshot');
    ...
    const GetEvents = (): EventService | undefined => Services.Resolve<EventService>('events');

    /** Minimal dependency-free fallback. External Events wins whenever registered. */
    const InternalObjectEvents = new WeakMap<object, Map<string, Set<EventListener>>>();
    const InternalValueEvents = new Map<unknown, Map<string, Set<EventListener>>>();

    const InternalBucket = (target: unknown, create = false): Map<string, Set<EventListener>> | undefined =>
    {
        const objectTarget = (typeof target === 'object' && target !== null) || typeof target === 'function';
        const store = objectTarget ? InternalObjectEvents : InternalValueEvents;
        let bucket = store.get(target as object & unknown);
        if(!bucket && create)
        {
            bucket = new Map<string, Set<EventListener>>();
            (store as Map<unknown, Map<string, Set<EventListener>>>).set(target, bucket);
        }
        return bucket;
    };

    const InternalOn = (target: unknown, types: string, handler: EventListener, options?: AddEventListenerOptions): void =>
    {
        const once = options?.once === true;
        for(const type of types.split(/[\s,|]+/).filter(Boolean))
        {
            const bucket = InternalBucket(target, true)!;
            let listeners = bucket.get(type);
            if(!listeners) bucket.set(type, listeners = new Set<EventListener>());
            if(once)
            {
                const wrapper: EventListener = event => { InternalOff(target, type, wrapper); handler(event); };
    ...
    const InternalOff = (target: unknown, types: string, handler: EventListener): void =>
    {
        const bucket = InternalBucket(target);
        if(!bucket) return;
        for(const type of types.split(/[\s,|]+/).filter(Boolean))
        {
            const listeners = bucket.get(type);
            listeners?.delete(handler);
            if(listeners?.size === 0) bucket.delete(type);
        }
        if(bucket.size === 0 && !((typeof target === 'object' && target !== null) || typeof target === 'function')) InternalValueEvents.delete(target);
    };

    const InternalHas = (target: unknown, type: string): boolean => Boolean(InternalBucket(target)?.get(type)?.size);

    const InternalFire = (target: unknown, type: string, detail?: unknown): boolean =>
    {
        const listeners = InternalBucket(target)?.get(type);
        if(!listeners?.size) return false;
        const CE = globalThis.CustomEvent;
        const event = typeof CE === 'function' ? new CE(type, { detail }) : new Event(type);
    ...
    /** Compiler/runtime-only structural mutation channel. It bypasses the
     *  global Events dispatcher for mounted compiled lists while public
     *  CollectionChanged events remain fully available to applications. */
    type CollectionInvalidator = (detail: CollectionChangeEvent) => void;

    type CollectionInvalidatorSlot =
        CollectionInvalidator |
        Set<CollectionInvalidator>;

    const CollectionInvalidators =
        new WeakMap<object, CollectionInvalidatorSlot>();

    export function RegisterCollectionInvalidator
    (
        target      : object,
        invalidator : CollectionInvalidator
    ): () => void
    {
        const raw = ToRaw(target);

        /* Compiled Array sinks live exclusively in ReactiveKernel. FULL collection
         * invalidators remain for Map/Set semantic events and compatibility. */
        if(Array.isArray(raw))
        {
            return ReactiveKernel.RegisterCollectionPrimitive
            (
                raw,
                (operation, index, deleteCount, added, removed) =>
                    invalidator
                    ({
                        Type: 'CollectionChanged',
                        Target: raw, Root: raw, Path: [], Collection: 'Array',
                        Operation: operation, Index: index, DeleteCount: deleteCount,
                        Added: [...added], Removed: [...removed], Args: [],
                        Version, Timestamp: Date.now()
                    })
            );
        }

        const current = CollectionInvalidators.get(raw);

        if(!current)
        {
            CollectionInvalidators.set(raw, invalidator);
        }
        else if(current instanceof Set)
        {
            current.add(invalidator);
        }
        else if(current !== invalidator)
        {
            CollectionInvalidators.set(raw, new Set([current, invalidator]));
        }

        return () =>
        {
            const slot = CollectionInvalidators.get(raw);
            if(!slot) return;

            if(slot instanceof Set)
            {
                slot.delete(invalidator);
                if(slot.size === 0) CollectionInvalidators.delete(raw);
                else if(slot.size === 1) CollectionInvalidators.set(raw, slot.values().next().value!);
                return;
            }

            if(slot === invalidator) CollectionInvalidators.delete(raw);
        };
    }

    const HasDirectCollectionListener = (target: object): boolean =>
        CollectionInvalidators.has(target);

    function InvalidateCollectionDirect
    (
        target : object,
        detail : CollectionChangeEvent
    ): boolean
    {
        const slot = CollectionInvalidators.get(target);
        if(!slot) return false;

        if(slot instanceof Set)
        {
            for(const invalidator of slot) invalidator(detail);
        }
        else
        {
            slot(detail);
    ...
    function HasPublicCollectionListener
    (
        phase: 'CollectionChanging' | 'CollectionChanged'
    ): boolean
    {
        const events = GetEvents();
        return Boolean(events?.Has?.(phase)) || InternalHas(CollectionTarget, phase);
    }
    ...
    {
        const events = GetEvents();
        const hasPublicListener = HasPublicCollectionListener(phase);
        const hasDirectListener =
            phase === 'CollectionChanged' &&
            collection === 'Array' &&
            HasDirectCollectionListener(target);

        // R23: if neither applications nor compiled lists observe this mutation,
        // preserve the zero-allocation fast path.
        if(!hasPublicListener && !hasDirectListener) return;
        ...
        {
            InvalidateCollectionDirect(target, detail);
        }

        if(hasPublicListener)
        {
            if(events) events.Fire(CollectionTarget, { Type: phase, Detail: detail as unknown as Record<string, unknown>, Cancelable: false });
            InternalFire(CollectionTarget, phase, detail);
        }
    }
    ...
    function RecordCollectionSnapshot(target: object): void
    {
        if(TransactionDepth === 0 || RollingBack) return;
        const snapshot = Array.isArray(target) ? target.slice() : target instanceof Map ? new Map(target) : target instanceof Set ? new Set(target) : null;
        if(snapshot !== null) RecordTransaction(target, CollectionSnapshotKey, true, snapshot);
    }
    ...
    /**
     * Direct invalidation channel for compiler-owned row bindings.
     *
     * Structural Array mutations still use CollectionChanged. A nested object
     * mutation may instead notify the mounted row record directly. The WeakMap key is the ownership boundary: when a raw row becomes unreachable,
     * its callback value becomes unreachable with the ephemeron entry. Explicit detach handles
     * rows that remain reachable after unmount.
     */
    type DirectInvalidator = (key?: Key) => void;


    export function AttachDirectInvalidator
    (
        target      : object,
        invalidator : DirectInvalidator
    ): void
    {
        ReactiveKernel.AttachDirectInvalidator(target, invalidator);
    }

    export function DetachDirectInvalidator
    (
        target      : object,
        invalidator : DirectInvalidator
    ): void
    {
        ReactiveKernel.DetachDirectInvalidator(target, invalidator);
    }

    export function RegisterDirectInvalidator
    (
        target      : object,
        invalidator : DirectInvalidator
    ): () => void
    {
        return ReactiveKernel.RegisterDirectInvalidator(target, invalidator);
    }

    function InvalidateDirect(target: object, key: Key): boolean
    {
        return ReactiveKernel.NotifyDirect(target, key);
    }
    ...
    function Wrap<T>(value: T, meta: ProxyMeta): T
    {
        ...
        {
            return ReactiveKernel.ReactiveObject
            (
                value as unknown as object[],
                {
                    Read: (item, key) =>
                        Wrap(item, { ...meta, Path: [...meta.Path, key] }),
    ...
    function CollectionMethod(target: Map<unknown, unknown> | Set<unknown>, key: Key, meta: ProxyMeta): unknown
    {
        ...
        if(key === 'add' && !isMap)
        {
            return (value: unknown) =>
            {
                ...
                RecordTransaction(target, rawValue as Key, false, undefined);
        ...
        if(key === 'clear')
        {
            return () =>
            {
                ...
                RecordCollectionSnapshot(target);
                const removed = isMap
    ...
    function ReactiveProxy(raw: object, meta: ProxyMeta): object
    {
        if(Array.isArray(raw))
        {
            ...
            (
                raw,
                {
                    Read: (item, key) => Wrap(item, { ...meta, Path: [...meta.Path, key] }),
                    Normalize: item => ToRaw(item),
                    Readonly: meta.Readonly,
                    BeforeMutate: target => RecordCollectionSnapshot(target),
                }
        ...
        const proxy = new Proxy(raw,
            {
                ...
                set(target, key, value, receiver)
                {
                     ...
                     *
                     * Compiler-owned rows use the direct invalidation channel:
                     * setter -> row sink closures. No collection event, no list
                     * reconciliation, no PatchListRecord dispatch.
                     *
                     * The semantic CollectionChanged/update bridge remains only
                     * as a compatibility fallback when no direct row binding is
                     * mounted for this object.
                     */
                    if
                    (
                        target !== meta.Root &&
                    ...
                    {
                        const delivered = InvalidateDirect(target, key);

                        if
                        (
                            !delivered &&
                            meta.Path.length > 0 &&
                            (Boolean(GetEvents()?.Has?.('CollectionChanged')) || InternalHas(CollectionTarget, 'CollectionChanged'))
                        )
                        {
                            const root = meta.Root as unknown[];
                            const candidate =
    ...
    export function ReactiveObject<T extends object>(source: T, options: ReactiveOptions = {}): T
    {
        ...
        if(Array.isArray(source))
        {
            ...
            (
                source,
                {
                    Read: meta.Shallow ? undefined : (item, key) => Wrap(item, { ...meta, Path: [key] }),
                    Normalize: item => ToRaw(item),
                    Readonly: meta.Readonly,
                    BeforeMutate: target => RecordCollectionSnapshot(target),
                }
        ...
        return ReactiveProxy(source, meta) as T;
    }
    ...
    {
        return IsObject(value) && (ProxyToRaw.has(value as object) || ReactiveKernel.ToRaw(value) !== value);
    }
    ...
    export function ToRaw<T>(value: T): T
    {
        ...
        const own = (ProxyToRaw.get(value as object) ?? value) as T;
        return ReactiveKernel.ToRaw(own);
    }
    ...
    export function CreateSignal<T>(initial: T, options: SignalOptions<T> = {}): SignalContract<T>
    {
        ...
        const base = ReactiveKernel.CreateSignal
        (
            initial,
            { Equals: options.Equals as ReactiveKernel.Equality<T> | undefined }
        );

        /* FULL computations subscribe to one lightweight bridge Source while
         * value storage/equality/revision remain owned by the minimal kernel Signal. */
        base.Subscribe(() =>
        {
            Version++;
            node.Notify();
        ...
        const signal: SignalContract<T> =
        {
            ...
            Peek(): T { return base.Peek(); },
            Set(next: T | ((previous: T) => T)): T
            {
                return base.Set(next);
            },
            Update(updater: (previous: T) => T): T { return base.Set(updater); },
            Touch(): void
            {
                Version++;
                node.Notify();
        ...
        catch(error)
        {
            ...
            try
            {
                for(let i = TransactionLog.length - 1; i >= start; i--)
                {
                    ...
                    if(entry.Key === CollectionSnapshotKey)
                    {
                        if(Array.isArray(entry.Target) && Array.isArray(entry.Old))
                            Array.prototype.splice.call(entry.Target, 0, entry.Target.length, ...entry.Old);
                        else if(entry.Target instanceof Map && entry.Old instanceof Map)
                        { entry.Target.clear(); for(const [key, value] of entry.Old) entry.Target.set(key, value); }
                        else if(entry.Target instanceof Set && entry.Old instanceof Set)
                        { entry.Target.clear(); for(const value of entry.Old) entry.Target.add(value); }
                    }
                    else if(entry.Target instanceof Map)
                    {
    ...
    export function BindAttribute(source: ReadonlySignalContract<unknown> | (() => unknown), element: Element, name: string): Stop
    {
        ...
        return CreateEffectPrimitive(() =>
        {
            const directives = Services.Directives;

            if(!directives)
            {
                throw new Error
                (
                    '[arianna] BindAttribute requires the Directives service.'
                );
            }

            directives.Attribute(element, name, read());
        });
    }
    ...
    export class Reactive<T extends object = object> extends EventTarget
    {
        ...
        On(types: string, handler: (event: ChangeEvent) => void, options?: AddEventListenerOptions): this
        {
            ...
            else InternalOn(this, types, handler as unknown as EventListener, options);
            return this;
        }
        ...
        Off(types: string, handler: (event: ChangeEvent) => void): this
        {
            ...
            InternalOff(this, types, handler as unknown as EventListener);
            return this;
        }
        ...
        Fire(event: ChangeEvent | string, detail: Partial<ChangeEvent> = {}): this
        {
            ...
            InternalFire(this, descriptor.Type, descriptor);
            return this;
        }
    ...
    new Services.Service('reactivity', API);
