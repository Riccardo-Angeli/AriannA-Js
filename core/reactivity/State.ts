...
export namespace States
{
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Format          = Types.State.Format;
    /** @name        HistoryKind
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type HistoryKind     = Types.State.HistoryKind;
    /** @name        Options
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Options         = Interfaces.State.Options;
    /** @name        HistoryEntry
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type HistoryEntry<T> = Interfaces.State.HistoryEntry<T>;
    /** @name        Snapshot
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Snapshot<T>     = Interfaces.State.Snapshot<T>;
    /** @name        Serializer
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type Serializer      = Interfaces.State.Serializer;
    /** @name        WorkerBridge
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type WorkerBridge    = Interfaces.State.WorkerBridge;
    /** @name        ChangeEvent
     *  @public
     *  @type        {type alias}
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ChangeEvent<T>  = Interfaces.State.ChangeEvent<T>;
     ...
     *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
     *  @license     MIT / Commercial (dual license) */
    export type ServiceContract = Interfaces.State.Service;
    ...
    (
        'state',
        {
             ...
             *  @public
             *  @param       {Serializer} serializer Serializer implementation.
             *  @returns     {ServiceContract} The State service for fluent chaining.
             *  @description Register a custom State serializer and return the State service for fluent chaining.
             *  @author      Riccardo Angeli
             *  @copyright   Riccardo Angeli 2012-2026 All Rights Reserved
             *  @license     MIT / Commercial (dual license) */
