...
import
{
    Vector2 as ImportedMathVector2,
    Vector3 as ImportedMathVector3,
    Vector4 as ImportedMathVector4,
...
{
    export const MathVector2    = ImportedMathVector2;
    export const MathVector3    = ImportedMathVector3;
    export const MathVector4    = ImportedMathVector4;
    export const MathQuaternion = ImportedMathQuaternion;
    export const MathMatrix4    = ImportedMathMatrix4;
    export const MathColor      = ImportedMathColor;
    ...
    export class Vec2
    {
        ...
        static fromMath(v: ImportedMathVector2): Vec2 { return new Vec2(v.x, v.y); }
        /** Math interop: produce a Math.Vector2 (immutable API) from this. */
        toMath(): ImportedMathVector2 { return new MathVector2(this.x, this.y); }
    }
    ...
    export class Vec3
    {
        ...
        static fromMath(v: ImportedMathVector3): Vec3 { return new Vec3(v.x, v.y, v.z); }
        /** Math interop: produce a Math.Vector3 (immutable API) from this. */
        toMath(): ImportedMathVector3 { return new MathVector3(this.x, this.y, this.z); }
    }
    ...
    export class Vec4
    {
        ...
        static fromMath(v: ImportedMathVector4): Vec4 { return new Vec4(v.x, v.y, v.z, v.w); }
        /** Math interop: produce a Math.Vector4 (immutable API) from this. */
        toMath(): ImportedMathVector4 { return new MathVector4(this.x, this.y, this.z, this.w); }
    }
    ...
    export class Quaternion
    {
        ...
        static fromMath(q: ImportedMathQuaternion): Quaternion { return new Quaternion(q.x, q.y, q.z, q.w); }
        /** Math interop: produce a Math.Quaternion from this. */
        toMath(): ImportedMathQuaternion { return new MathQuaternion(this.x, this.y, this.z, this.w); }
    }
...
// ── Color ─────────────────────────────────────────────────────────────────────
    ...
    export class Color
    {
         ...
         */
        static fromMath(c: ImportedMathColor): Color { return new Color(c.r/255, c.g/255, c.b/255, c.a); }
        /** Math interop: produce a Math.Color (0..255 scale) from this (0..1 scale). */
        toMath(): ImportedMathColor { return new MathColor(this.r*255, this.g*255, this.b*255, this.a); }
    }
