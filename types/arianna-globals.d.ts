...
declare module 'types/arianna' {
    ...
    export { default as Observable, signal, signalMono, effect, computed,
             batch, untrack, uuid, AriannATemplate } from './core/Observables.ts';
    ...
    export { default as Directive } from './core/Directives.ts';
    ...
    export { default as Namespace } from './core/Core.ts';
    ...
    export type { Signal, SignalMono, ReadonlySignal, AriannAEvent,
                  ListenerOptions }                from './core/Observables.ts';
    ...
    export type { ComponentMeta }                  from './core/Directives.ts';
