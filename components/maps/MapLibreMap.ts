...
export class MapLibreMap extends MapEmbed {
...
/* ──────────────────────────────────────────────────────────────────────────
 * MapLibreMap namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace MapLibreMap {
    export namespace Types {
        export type MapLibreInstanceType = MapLibreInstance;
    }
    export namespace Interfaces {
        export interface MapLibreGlobalContract extends MapLibreGlobal {
        }
    }
    export const LoadMapLibre = loadMapLibre;
}
