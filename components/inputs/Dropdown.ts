...
export class Dropdown extends HTMLElement {
    ...
    onConnected(_opts: DropdownOptions = {}) {
        const value = this.signal().attribute('value');
        const selected = (): DropdownOption | undefined => this.options$.Get().find(o => o.value === (value.Get() ?? ''));
        ...
        this.optCls = (o: DropdownOption) => 'ar-dropdown__option'
...
/* ──────────────────────────────────────────────────────────────────────────
 * Dropdown namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace Dropdown {
    export namespace Interfaces {
        export interface Option extends DropdownOption {
        }
        export interface Options extends DropdownOptions {
        }
    }
}
