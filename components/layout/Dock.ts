 ...
 * Attributes:  style ('macos' | 'windows'), magnify, position ('bottom'|'left'|'right'), start-label
 */
...
/* ──────────────────────────────────────────────────────────────────────────
 * Dock namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace Dock {
    export namespace Types {
        export type Style = DockStyle;
    }
    export namespace Interfaces {
        export interface Item extends DockItem {
        }
        export interface Options extends DockOptions {
        }
        export interface RenderedIconContract extends RenderedIcon {
        }
    }
    export const ClassifyIcon = classifyIcon;
}
export default Dock;
