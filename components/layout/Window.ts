...
export class WindowComponent extends HTMLElement {
    ...
    onConnected(_opts: WindowOptions = {}) {
...
/* ──────────────────────────────────────────────────────────────────────────
 * WindowComponent namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace WindowComponent {
    export namespace Types {
        export type WindowStyleType = WindowStyle;
    }
    export namespace Interfaces {
        export interface WindowMenuItemContract extends WindowMenuItem {
        }
        export interface WindowOptionsContract extends WindowOptions {
        }
    }
}
