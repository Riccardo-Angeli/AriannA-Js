 ...
 *
 * Attributes (declarative): for, amplitude, frequency, axis, direction, animate, enabled
 */
import { Component } from '../../../core/index.ts';
import { Modifier3D, Modifier3DElement, _cloneGeom, _recomputeNormals, type MeshLike, type CameraLike, } from './Base.ts';
...
export class WaveModifier extends Modifier3D {
    ...
    apply(time?: number): this {
        ...
        if (!this.#baseGeometry)
            this.#baseGeometry = _cloneGeom(this.mesh.geometry);
...
export class WaveModifierElement extends Modifier3DElement {
...
/* ──────────────────────────────────────────────────────────────────────────
 * WaveModifier namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace WaveModifier {
    export namespace Interfaces {
        export interface Options extends WaveModifierOptions {
        }
    }
}
/* ──────────────────────────────────────────────────────────────────────────
 * WaveModifierElement namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace WaveModifierElement {
}
