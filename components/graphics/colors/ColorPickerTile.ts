...
export class ColorPickerTile extends HTMLElement {
    ...
    onConnected(_opts: ColorPickerTileOptions = {}) {
...
/* ──────────────────────────────────────────────────────────────────────────
 * ColorPickerTile namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace ColorPickerTile {
    export namespace Interfaces {
        export interface Options extends ColorPickerTileOptions {
        }
        export interface TileStateContract extends TileState {
        }
    }
}
