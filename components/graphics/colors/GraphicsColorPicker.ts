...
export interface Color extends RGB, HSL {
    hex: string;
    a: number;
}
...
export class GraphicsColorPicker extends HTMLElement {
    ...
    onConnected(_opts: ColorPickerOptions = {}) {
        // Reactive predicates
    ...
    setColor(c: string | Partial<RGB> | Partial<HSL> | {
        a?: number;
    }): this {
        const cur = this.state$.Get();
...
/* ──────────────────────────────────────────────────────────────────────────
 * GraphicsColorPicker namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace GraphicsColorPicker {
    export namespace Interfaces {
        export interface RGBContract extends RGB {
        }
        export interface HSLContract extends HSL {
        }
        export interface ColorContract extends Color {
        }
        export interface ColorPickerOptionsContract extends ColorPickerOptions {
        }
        export interface PickerStateContract extends PickerState {
        }
    }
    export const ParseHexRgba = parseHexRgba;
