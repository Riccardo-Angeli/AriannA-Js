...
export class LinearGradientEditor extends HTMLElement {
    ...
    state = makeStopState();
    onConnected(_opts: LinearGradientEditorOptions = {}) {
        ...
        const interp = (): GradientInterp => (interpAttr.Get() as GradientInterp | null) ?? 'srgb';
...
/* ──────────────────────────────────────────────────────────────────────────
 * LinearGradientEditor namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace LinearGradientEditor {
    export namespace Types {
        export type GradientInterpType = GradientInterp;
    }
    export namespace Interfaces {
        export interface Options extends LinearGradientEditorOptions {
        }
    }
}
