...
export class Canvas2D extends HTMLElement {
    ...
    onConnected(_opts: Canvas2DOptions = {}) {
...
/* ──────────────────────────────────────────────────────────────────────────
 * Canvas2D namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace Canvas2D {
    export namespace Interfaces {
        export interface Vec2Contract extends Vec2 {
        }
        export interface Options extends Canvas2DOptions {
        }
        export interface ViewportStateContract extends ViewportState {
        }
    }
}
