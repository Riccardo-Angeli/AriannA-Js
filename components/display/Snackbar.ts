...
export class Snackbar extends HTMLElement {
    ...
    #timer: number = 0;
    onConnected(_opts: SnackbarOptions = {}) {
...
/* ──────────────────────────────────────────────────────────────────────────
 * Snackbar namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace Snackbar {
    export namespace Types {
        export type Position = SnackbarPosition;
    }
    export namespace Interfaces {
        export interface Options extends SnackbarOptions {
        }
    }
    export const GetContainer = getContainer;
    export const ApplyContainerPosition = applyContainerPosition;
}
