...
export class CreditCard extends HTMLElement {
    ...
    onConnected(_opts: CreditCardOptions = {} as CreditCardOptions) {
...
/* ──────────────────────────────────────────────────────────────────────────
 * CreditCard namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace CreditCard {
    export namespace Types {
        export type CardBrandType = CardBrand;
    }
    export namespace Interfaces {
        export interface CardDataContract extends CardData {
        }
        export interface Options extends CreditCardOptions {
        }
        export interface CardFormStateContract extends CardFormState {
        }
    }
    export const DetectBrand = detectBrand;
    export const LuhnCheck = luhnCheck;
    export const FormatCardNumber = formatCardNumber;
}
