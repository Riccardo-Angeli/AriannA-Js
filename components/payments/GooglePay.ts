 ...
 *
 * Attributes: merchant-id, merchant-name, country-code, currency, amount,
...
export class GooglePay extends HTMLElement {
    ...
    onConnected(_opts: GooglePayOptions = {} as GooglePayOptions) {
...
/* ──────────────────────────────────────────────────────────────────────────
 * GooglePay namespace — public component contracts and module helpers.
 * ────────────────────────────────────────────────────────────────────────── */
export namespace GooglePay {
    export namespace Types {
        export type Environment = GooglePayEnvironment;
        export type ButtonColor = GooglePayButtonColor;
        export type ButtonType = GooglePayButtonType;
    }
    export namespace Interfaces {
        export interface Options extends GooglePayOptions {
        }
    }
}
