 ...
 * @description Pure AriannA light-DOM code editor with syntax highlighting, line numbers,
 *              browser-native selection and editing, and reactive public state.
...
export class CodeEditor extends HTMLElement {
    ...
    static #RulesFor(language: CodeEditor.Types.Language): ReadonlyArray<{
        kind: string;
        re: RegExp;
    }> {
        switch (language) {
    ...
    static #Tokenize(source: string, language: CodeEditor.Types.Language): Array<{
        kind: string;
        text: string;
    }> {
    ...
    declare language: Reactivity.Signal<CodeEditor.Types.Language>;
    ...
    constructor(opts: CodeEditor.Interfaces.Options = {}) {
        super();
    ...
    _initFields(opts: CodeEditor.Interfaces.Options = {}): void {
        if (this.__fieldsInitialized)
            return;
        this.__fieldsInitialized = true;
        const attrLang = this.getAttribute('language') as CodeEditor.Types.Language | null;
    ...
    get Language(): CodeEditor.Types.Language { return this.language.Get(); }
    set Language(l: CodeEditor.Types.Language) { this.language.Set(l); this._render(); }
